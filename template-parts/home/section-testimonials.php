...
<?php if (have_rows('custom_items')): $i = 0; ?>
  <section class="home-testimonials pt-5 pb-5">
    <div class="container-fluid">
      <div class="row justify-content-center">
      <div class="col-lg-8 text-center z-1">
        <div class="services__intro-header wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
      ...
      <div class="swiper swiper-testimonials px-4">
